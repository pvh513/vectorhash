...
64-bit versions mentioned above. One caveat is that the 32-bit library will be
...
<tt>INSTALLDIR/lib64</tt> (for the 64-bit library), <tt>INSTALLDIR/lib</tt>
(for the 32-bit library), <tt>INSTALLDIR/include</tt> (for the header file),
and <tt>INSTALLDIR/man/man*</tt> (for the man pages). So the default location
for installing the 64-bit library is <tt>/usr/local/lib64</tt>. This may not
