...
namespace {
	...
	{
		VectorHash32_512(buffer, 0, 0xfd4c799d, cksum, 512);
	...
	{
		VectorHash32_1024(buffer, 0, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test128ByteBufferScalar_32)
	{
		...
		VectorHash32_32(buffer, 128, 0xfd4c799d, cksum, 32);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_64(buffer, 128, 0xfd4c799d, cksum, 64);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_128(buffer, 128, 0xfd4c799d, cksum, 96);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_128(buffer, 128, 0xfd4c799d, cksum, 128);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_256(buffer, 128, 0xfd4c799d, cksum, 160);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_256(buffer, 128, 0xfd4c799d, cksum, 192);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_256(buffer, 128, 0xfd4c799d, cksum, 224);
	...
	{
		CHECK( ReadBuffer("test0128", 128, buffer) );
		VectorHash32_256(buffer, 128, 0xfd4c799d, cksum, 256);
	...
	TEST(Test256ByteBufferScalar_384)
	{
		...
		VectorHash32_512(buffer, 256, 0xfd4c799d, cksum, 384);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_512(buffer, 256, 0xfd4c799d, cksum, 512);
	...
	TEST(Test512ByteBufferScalar_768)
	{
		...
		VectorHash32_1024(buffer, 512, 0xfd4c799d, cksum, 768);
	...
	{
		CHECK( ReadBuffer("test0512", 512, buffer) );
		VectorHash32_1024(buffer, 512, 0xfd4c799d, cksum, 1024);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_32(buffer, 256, 0xfd4c799d, cksum, 32);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_64(buffer, 256, 0xfd4c799d, cksum, 64);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_128(buffer, 256, 0xfd4c799d, cksum, 96);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_128(buffer, 256, 0xfd4c799d, cksum, 128);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_256(buffer, 256, 0xfd4c799d, cksum, 160);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_256(buffer, 256, 0xfd4c799d, cksum, 192);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_256(buffer, 256, 0xfd4c799d, cksum, 224);
	...
	{
		CHECK( ReadBuffer("test0256", 256, buffer) );
		VectorHash32_256(buffer, 256, 0xfd4c799d, cksum, 256);
	...
	{
		CHECK( ReadBuffer("test0512", 512, buffer) );
		VectorHash32_512(buffer, 512, 0xfd4c799d, cksum, 384);
	...
	{
		CHECK( ReadBuffer("test0512", 512, buffer) );
		VectorHash32_512(buffer, 512, 0xfd4c799d, cksum, 512);
	...
	TEST(Test1024ByteBufferScalar_768)
	{
		...
		VectorHash32_1024(buffer, 1024, 0xfd4c799d, cksum, 768);
	...
	{
		CHECK( ReadBuffer("test1024", 1024, buffer) );
		VectorHash32_1024(buffer, 1024, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test384ByteBufferScalar_32)
	{
		...
		VectorHash32_32(buffer, 384, 0xfd4c799d, cksum, 32);
	...
	{
		CHECK( ReadBuffer("test0384", 384, buffer) );
		VectorHash32_64(buffer, 384, 0xfd4c799d, cksum, 64);
	...
	{
		CHECK( ReadBuffer("test0384", 384, buffer) );
		VectorHash32_128(buffer, 384, 0xfd4c799d, cksum, 128);
	...
	{
		CHECK( ReadBuffer("test0384", 384, buffer) );
		VectorHash32_256(buffer, 384, 0xfd4c799d, cksum, 256);
	...
	TEST(Test768ByteBufferScalar_512)
	{
		...
		VectorHash32_512(buffer, 768, 0xfd4c799d, cksum, 512);
	...
	TEST(Test1536ByteBufferScalar_1024)
	{
		...
		VectorHash32_1024(buffer, 1536, 0xfd4c799d, cksum, 1024);
	...
	TEST(TestLargeBufferScalar_32)
	{
		...
		VectorHash32_32(buffer, 1048576, 0xfd4c799d, cksum, 32);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_64(buffer, 1048576, 0xfd4c799d, cksum, 64);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_128(buffer, 1048576, 0xfd4c799d, cksum, 128);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_256(buffer, 1048576, 0xfd4c799d, cksum, 256);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_512(buffer, 1048576, 0xfd4c799d, cksum, 512);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_1024(buffer, 1048576, 0xfd4c799d, cksum, 1024);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_32(buffer, 1048576, 0x6ec74615, cksum, 32);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_64(buffer, 1048576, 0x6ec74615, cksum, 64);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_128(buffer, 1048576, 0x6ec74615, cksum, 128);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_256(buffer, 1048576, 0x6ec74615, cksum, 256);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_512(buffer, 1048576, 0x6ec74615, cksum, 512);
	...
	{
		CHECK( ReadBuffer("test9999", 1048576, buffer) );
		VectorHash32_1024(buffer, 1048576, 0x6ec74615, cksum, 1024);
