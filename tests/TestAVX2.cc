...
namespace {
	...
	TEST(TestZeroLengthBufferAVX2_32)
	{
		...
		{
			VectorHash256_32(buffer, 0, 0xfd4c799d, cksum, 32);
	...
	TEST(TestZeroLengthBufferAVX2_64)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			VectorHash256_64(buffer, 0, 0xfd4c799d, cksum, 64);
	...
	TEST(TestZeroLengthBufferAVX2_128)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			VectorHash256_128(buffer, 0, 0xfd4c799d, cksum, 128);
	...
	TEST(TestZeroLengthBufferAVX2_256)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			VectorHash256_256(buffer, 0, 0xfd4c799d, cksum, 256);
	...
	TEST(TestZeroLengthBufferAVX2_512)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			VectorHash256_512(buffer, 0, 0xfd4c799d, cksum, 512);
	...
	TEST(TestZeroLengthBufferAVX2_1024)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			VectorHash256_1024(buffer, 0, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test128ByteBufferAVX2_32)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_32(buffer, 128, 0xfd4c799d, cksum, 32);
	...
	TEST(Test128ByteBufferAVX2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_64(buffer, 128, 0xfd4c799d, cksum, 64);
	...
	TEST(Test128ByteBufferAVX2_96)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_128(buffer, 128, 0xfd4c799d, cksum, 96);
	...
	TEST(Test128ByteBufferAVX2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_128(buffer, 128, 0xfd4c799d, cksum, 128);
	...
	TEST(Test128ByteBufferAVX2_160)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_256(buffer, 128, 0xfd4c799d, cksum, 160);
	...
	TEST(Test128ByteBufferAVX2_192)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_256(buffer, 128, 0xfd4c799d, cksum, 192);
	...
	TEST(Test128ByteBufferAVX2_224)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_256(buffer, 128, 0xfd4c799d, cksum, 224);
	...
	TEST(Test128ByteBufferAVX2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash256_256(buffer, 128, 0xfd4c799d, cksum, 256);
	...
	TEST(Test256ByteBufferAVX2_384)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_512(buffer, 256, 0xfd4c799d, cksum, 384);
	...
	TEST(Test256ByteBufferAVX2_512)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_512(buffer, 256, 0xfd4c799d, cksum, 512);
	...
	TEST(Test512ByteBufferAVX2_768)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_1024(buffer, 512, 0xfd4c799d, cksum, 768);
	...
	TEST(Test512ByteBufferAVX2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash256_1024(buffer, 512, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test256ByteBufferAVX2_32)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_32(buffer, 256, 0xfd4c799d, cksum, 32);
	...
	TEST(Test256ByteBufferAVX2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_64(buffer, 256, 0xfd4c799d, cksum, 64);
	...
	TEST(Test256ByteBufferAVX2_96)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_128(buffer, 256, 0xfd4c799d, cksum, 96);
	...
	TEST(Test256ByteBufferAVX2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_128(buffer, 256, 0xfd4c799d, cksum, 128);
	...
	TEST(Test256ByteBufferAVX2_160)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_256(buffer, 256, 0xfd4c799d, cksum, 160);
	...
	TEST(Test256ByteBufferAVX2_192)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_256(buffer, 256, 0xfd4c799d, cksum, 192);
	...
	TEST(Test256ByteBufferAVX2_224)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_256(buffer, 256, 0xfd4c799d, cksum, 224);
	...
	TEST(Test256ByteBufferAVX2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash256_256(buffer, 256, 0xfd4c799d, cksum, 256);
	...
	TEST(Test512ByteBufferAVX2_384)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash256_512(buffer, 512, 0xfd4c799d, cksum, 384);
	...
	TEST(Test512ByteBufferAVX2_512)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash256_512(buffer, 512, 0xfd4c799d, cksum, 512);
	...
	TEST(Test1024ByteBufferAVX2_768)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_1024(buffer, 1024, 0xfd4c799d, cksum, 768);
	...
	TEST(Test1024ByteBufferAVX2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test1024", 1024, buffer) );
			VectorHash256_1024(buffer, 1024, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test384ByteBufferAVX2_32)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_32(buffer, 384, 0xfd4c799d, cksum, 32);
	...
	TEST(Test384ByteBufferAVX2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash256_64(buffer, 384, 0xfd4c799d, cksum, 64);
	...
	TEST(Test384ByteBufferAVX2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash256_128(buffer, 384, 0xfd4c799d, cksum, 128);
	...
	TEST(Test384ByteBufferAVX2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash256_256(buffer, 384, 0xfd4c799d, cksum, 256);
	...
	TEST(Test768ByteBufferAVX2_512)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_512(buffer, 768, 0xfd4c799d, cksum, 512);
	...
	TEST(Test1536ByteBufferAVX2_1024)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_1024(buffer, 1536, 0xfd4c799d, cksum, 1024);
	...
	TEST(TestLargeBufferAVX2_32)
	{
		if( SIMDversion >= IS_AVX2 )
		{
			...
			VectorHash256_32(buffer, 1048576, 0xfd4c799d, cksum, 32);
	...
	TEST(TestLargeBufferAVX2_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_64(buffer, 1048576, 0xfd4c799d, cksum, 64);
	...
	TEST(TestLargeBufferAVX2_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_128(buffer, 1048576, 0xfd4c799d, cksum, 128);
	...
	TEST(TestLargeBufferAVX2_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_256(buffer, 1048576, 0xfd4c799d, cksum, 256);
	...
	TEST(TestLargeBufferAVX2_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_512(buffer, 1048576, 0xfd4c799d, cksum, 512);
	...
	TEST(TestLargeBufferAVX2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_1024(buffer, 1048576, 0xfd4c799d, cksum, 1024);
	...
	TEST(TestLargeBufferAltSeedAVX2_32)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_32(buffer, 1048576, 0x6ec74615, cksum, 32);
	...
	TEST(TestLargeBufferAltSeedAVX2_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_64(buffer, 1048576, 0x6ec74615, cksum, 64);
	...
	TEST(TestLargeBufferAltSeedAVX2_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_128(buffer, 1048576, 0x6ec74615, cksum, 128);
	...
	TEST(TestLargeBufferAltSeedAVX2_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_256(buffer, 1048576, 0x6ec74615, cksum, 256);
	...
	TEST(TestLargeBufferAltSeedAVX2_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_512(buffer, 1048576, 0x6ec74615, cksum, 512);
	...
	TEST(TestLargeBufferAltSeedAVX2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash256_1024(buffer, 1048576, 0x6ec74615, cksum, 1024);
