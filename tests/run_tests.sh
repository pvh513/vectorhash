...
test_cks_file "../bin/vh32sum test*" "output_32.txt"
test_cks_file "../bin/vh128sum -l64 test*" "output_64.txt"
test_cks_file "../bin/vh128sum test*" "output_128.txt"
test_cks_file "../bin/vh128sum -l256 test*" "output_256.txt"
test_cks_file "../bin/vh128sum --length 512 test*" "output_512.txt"
test_cks_file "../bin/vh1024sum test*" "output_1024.txt"

test_cks_file "../bin/vh32sum --tag test*" "BSD_output_32.txt"
...
test_cks_file "../bin/vh1024sum --tag test*" "BSD_output_1024.txt"

test_cks_file "../bin/vh32sum --tag --scalar test*" "BSD_output_32.txt"
...
test_cks_file "../bin/vh128sum --scalar --tag --length 512 -- test*" "BSD_output_512.txt"
test_cks_file "../bin/vh1024sum --scalar --tag test*" "BSD_output_1024.txt"

test_cks_file "../bin/vh128sum --zero test*" "output_zero_128.txt"
test_cks_file "../bin/vh128sum --tag -z test*" "BSD_output_zero_128.txt"

test_cks_stdin "../bin/vh32sum" "test0128" "output_32.txt"
test_cks_stdin "../bin/vh32sum -" "test0256" "output_32.txt"
test_cks_stdin "../bin/vh32sum --scalar" "test0256" "output_32.txt"
test_cks_stdin "../bin/vh64sum" "test0128" "output_64.txt"
test_cks_stdin "../bin/vh64sum -" "test0512" "output_64.txt"
test_cks_stdin "../bin/vh64sum --scalar" "test0512" "output_64.txt"
test_cks_stdin "../bin/vh128sum" "test0128" "output_128.txt"
test_cks_stdin "../bin/vh128sum -" "test1024" "output_128.txt"
test_cks_stdin "../bin/vh128sum --scalar" "test1024" "output_128.txt"
test_cks_stdin "../bin/vh256sum" "test0128" "output_256.txt"
test_cks_stdin "../bin/vh256sum -" "test1536" "output_256.txt"
test_cks_stdin "../bin/vh256sum --scalar" "test1536" "output_256.txt"
test_cks_stdin "../bin/vh512sum" "test0128" "output_512.txt"
test_cks_stdin "../bin/vh512sum -" "test2048" "output_512.txt"
test_cks_stdin "../bin/vh512sum --scalar" "test2048" "output_512.txt"
test_cks_stdin "../bin/vh1024sum" "test0128" "output_1024.txt"
test_cks_stdin "../bin/vh1024sum -" "test3072" "output_1024.txt"
test_cks_stdin "../bin/vh1024sum --scalar" "test3072" "output_1024.txt"

check_cmd "../bin/vh32sum -c output_32.txt"
...
check_cmd "../bin/vh1024sum --check output_1024.txt"

check_cmd "../bin/vh32sum -cQ BSD_output_32.txt"
...
check_cmd "../bin/vh1024sum --check --stat BSD_output_1024.txt"
...
check_error_msg "../bin/vh64sum tost0000 -- --arg '' test0000" ": tost0000: No such file or directory"
check_error_msg "../bin/vh64sum tost0000 -- --arg '' test0000" ": --arg: No such file or directory"
check_error_msg "../bin/vh64sum tost0000 -- --arg '' test0000" ": '': No such file or directory"
check_error_msg "../bin/vh64sum tost0000 -- --arg '' test0000" "73711a77d6031b6f  test0000"

check_error_msg "../bin/vh64sum -G" "invalid option -- 'G'"
check_error_msg "../bin/vh64sum --ver" "unrecognized option '--ver'"
check_error_msg "../bin/vh64sum -l sum" "invalid length: 'sum'"
check_error_msg "../bin/vh64sum -l 156" "invalid length: '156'"
check_error_msg "../bin/vh64sum -l156" "length must be 32, 64, 128, 256, 512, or 1024"
check_error_msg "../bin/vh64sum --len sum" "invalid length: 'sum'"
check_error_msg "../bin/vh64sum --length 156" "invalid length: '156'"
check_error_msg "../bin/vh64sum --length 156" "length must be 32, 64, 128, 256, 512, or 1024"
check_error_msg "../bin/vh64sum tost0000" "tost0000: No such file or directory"

check_error_msg "../bin/vh64sum -i test0128" "the --ignore-missing option is meaningful only when verifying checksums"
check_error_msg "../bin/vh64sum -Q test0128" "the --status option is meaningful only when verifying checksums"
check_error_msg "../bin/vh64sum -q test0128" "the --quiet option is meaningful only when verifying checksums"
check_error_msg "../bin/vh64sum -w test0128" "the --warn option is meaningful only when verifying checksums"
check_error_msg "../bin/vh64sum -s test0128" "the --strict option is meaningful only when verifying checksums"
check_error_msg "../bin/vh64sum --tag -c BSD_output_64.txt" "the --tag option is meaningless when verifying checksums"
check_error_msg "../bin/vh64sum --tag -t test0128" ": --tag does not support --text mode"
check_error_msg "../bin/vh64sum -ct output_64.txt" "the --binary and --text options are meaningless when verifying checksums"
check_error_msg "../bin/vh64sum -c --text output_64.txt" "the --binary and --text options are meaningless when verifying checksums"
check_error_msg "../bin/vh64sum -cb output_64.txt" "the --binary and --text options are meaningless when verifying checksums"
check_error_msg "../bin/vh64sum -c --binary output_64.txt" "the --binary and --text options are meaningless when verifying checksums"
check_error_msg "../bin/vh128sum -cz output_zero_128.txt" "the --zero option is not supported when verifying checksums"
check_error_msg "../bin/vh64sum -cQ --verbose output_64.txt" "the --verbose option conflicts with --status"

check_error_msg "../bin/vh32sum --check --strict error0_32.txt" "WARNING: 1 line is improperly formatted"
