...
namespace {
	...
	TEST(TestZeroLengthBufferSSE2_32)
	{
		...
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_SSE2, 32);
	...
	TEST(TestZeroLengthBufferSSE2_64)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_SSE2, 64);
	...
	TEST(TestZeroLengthBufferSSE2_128)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_SSE2, 128);
	...
	TEST(TestZeroLengthBufferSSE2_256)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_SSE2, 256);
	...
	TEST(TestZeroLengthBufferSSE2_512)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_SSE2, 512);
	...
	TEST(TestZeroLengthBufferSSE2_1024)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_SSE2, 1024);
	...
	TEST(Test128ByteBufferSSE2_32)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 32);
	...
	TEST(Test128ByteBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 64);
			CHECK( CheckHash(cksum, "a9b41194bceedd04") );
		}
	}

	TEST(Test128ByteBufferSSE2_96)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 96);
	...
	TEST(Test128ByteBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 128);
			CHECK( CheckHash(cksum, "970566856108ce7bce658104386829fa") );
		}
	}

	TEST(Test128ByteBufferSSE2_160)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 160);
			CHECK( CheckHash(cksum, "efa539560f142d7e5d1a3dc9b81f7bdf2c2b94f8") );
		}
	}

	TEST(Test128ByteBufferSSE2_192)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 192);
			CHECK( CheckHash(cksum, "6a109d9852be15a9053bb48121de06bf95006085df2f9c55") );
		}
	}

	TEST(Test128ByteBufferSSE2_224)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 224);
	...
	TEST(Test128ByteBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_SSE2, 256);
			CHECK( CheckHash(cksum, "630b825fec4275e28b02590c53db6d920e3647133d5300a1e2887861867dfcf0") );
		}
	}

	TEST(Test256ByteBufferSSE2_384)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 384);
	...
	TEST(Test256ByteBufferSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 512);
	...
	TEST(Test512ByteBufferSSE2_768)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_SSE2, 768);
	...
	TEST(Test512ByteBufferSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_SSE2, 1024);
	...
	TEST(Test256ByteBufferSSE2_32)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 32);
	...
	TEST(Test256ByteBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 64);
			CHECK( CheckHash(cksum, "81534826f50039f6") );
		}
	}

	TEST(Test256ByteBufferSSE2_96)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 96);
	...
	TEST(Test256ByteBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 128);
			CHECK( CheckHash(cksum, "b384fcaef98a474cd776074b9d78bca9") );
		}
	}

	TEST(Test256ByteBufferSSE2_160)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 160);
			CHECK( CheckHash(cksum, "adf261ccc63e8066e51e6c096d32b39fcddbf78e") );
		}
	}

	TEST(Test256ByteBufferSSE2_192)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 192);
			CHECK( CheckHash(cksum, "7d3a49576f3a7d8799a7bdfeef254e39a8712c1bcbc5ad54") );
		}
	}

	TEST(Test256ByteBufferSSE2_224)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 224);
	...
	TEST(Test256ByteBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_SSE2, 256);
			CHECK( CheckHash(cksum, "96750ccd5f66ee6fcf17f512abecd3339e487a437976ad5947589e070d8e8d9e") );
		}
	}

	TEST(Test512ByteBufferSSE2_384)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_SSE2, 384);
	...
	TEST(Test512ByteBufferSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_SSE2, 512);
	...
	TEST(Test1024ByteBufferSSE2_768)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			CHECK( ReadBuffer("test1024", 1024, buffer) );
			VectorHashSIMD(buffer, 1024, 0xfd4c799d, cksum, IS_SSE2, 768);
	...
	TEST(Test1024ByteBufferSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test1024", 1024, buffer) );
			VectorHashSIMD(buffer, 1024, 0xfd4c799d, cksum, IS_SSE2, 1024);
	...
	TEST(Test384ByteBufferSSE2_32)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_SSE2, 32);
	...
	TEST(Test384ByteBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_SSE2, 64);
	...
	TEST(Test384ByteBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_SSE2, 128);
	...
	TEST(Test384ByteBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_SSE2, 256);
	...
	TEST(Test768ByteBufferSSE2_512)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHashSIMD(buffer, 768, 0xfd4c799d, cksum, IS_SSE2, 512);
	...
	TEST(Test1536ByteBufferSSE2_1024)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHashSIMD(buffer, 1536, 0xfd4c799d, cksum, IS_SSE2, 1024);
	...
	TEST(TestLargeBufferSSE2_32)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_SSE2, 32);
	...
	TEST(TestLargeBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_SSE2, 64);
	...
	TEST(TestLargeBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_SSE2, 128);
	...
	TEST(TestLargeBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_SSE2, 256);
	...
	TEST(TestLargeBufferSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_SSE2, 512);
	...
	TEST(TestLargeBufferSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_SSE2, 1024);
	...
	TEST(TestLargeBufferAltSeedSSE2_32)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_SSE2, 32);
	...
	TEST(TestLargeBufferAltSeedSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_SSE2, 64);
	...
	TEST(TestLargeBufferAltSeedSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_SSE2, 128);
	...
	TEST(TestLargeBufferAltSeedSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_SSE2, 256);
	...
	TEST(TestLargeBufferAltSeedSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_SSE2, 512);
	...
	TEST(TestLargeBufferAltSeedSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_SSE2, 1024);
