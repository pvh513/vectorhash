...
namespace {
	...
	TEST(TestZeroLengthBufferSSE2_32)
	{
		...
		{
			VectorHash128_32(buffer, 0, 0xfd4c799d, cksum, 32);
	...
	TEST(TestZeroLengthBufferSSE2_64)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHash128_64(buffer, 0, 0xfd4c799d, cksum, 64);
	...
	TEST(TestZeroLengthBufferSSE2_128)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHash128_128(buffer, 0, 0xfd4c799d, cksum, 128);
	...
	TEST(TestZeroLengthBufferSSE2_256)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHash128_256(buffer, 0, 0xfd4c799d, cksum, 256);
	...
	TEST(TestZeroLengthBufferSSE2_512)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHash128_512(buffer, 0, 0xfd4c799d, cksum, 512);
	...
	TEST(TestZeroLengthBufferSSE2_1024)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			VectorHash128_1024(buffer, 0, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test128ByteBufferSSE2_32)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_32(buffer, 128, 0xfd4c799d, cksum, 32);
	...
	TEST(Test128ByteBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_64(buffer, 128, 0xfd4c799d, cksum, 64);
	...
	TEST(Test128ByteBufferSSE2_96)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_128(buffer, 128, 0xfd4c799d, cksum, 96);
	...
	TEST(Test128ByteBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_128(buffer, 128, 0xfd4c799d, cksum, 128);
	...
	TEST(Test128ByteBufferSSE2_160)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_256(buffer, 128, 0xfd4c799d, cksum, 160);
	...
	TEST(Test128ByteBufferSSE2_192)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_256(buffer, 128, 0xfd4c799d, cksum, 192);
	...
	TEST(Test128ByteBufferSSE2_224)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_256(buffer, 128, 0xfd4c799d, cksum, 224);
	...
	TEST(Test128ByteBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash128_256(buffer, 128, 0xfd4c799d, cksum, 256);
	...
	TEST(Test256ByteBufferSSE2_384)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_512(buffer, 256, 0xfd4c799d, cksum, 384);
	...
	TEST(Test256ByteBufferSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_512(buffer, 256, 0xfd4c799d, cksum, 512);
	...
	TEST(Test512ByteBufferSSE2_768)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_1024(buffer, 512, 0xfd4c799d, cksum, 768);
	...
	TEST(Test512ByteBufferSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash128_1024(buffer, 512, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test256ByteBufferSSE2_32)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_32(buffer, 256, 0xfd4c799d, cksum, 32);
	...
	TEST(Test256ByteBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_64(buffer, 256, 0xfd4c799d, cksum, 64);
	...
	TEST(Test256ByteBufferSSE2_96)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_128(buffer, 256, 0xfd4c799d, cksum, 96);
	...
	TEST(Test256ByteBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_128(buffer, 256, 0xfd4c799d, cksum, 128);
	...
	TEST(Test256ByteBufferSSE2_160)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_256(buffer, 256, 0xfd4c799d, cksum, 160);
	...
	TEST(Test256ByteBufferSSE2_192)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_256(buffer, 256, 0xfd4c799d, cksum, 192);
	...
	TEST(Test256ByteBufferSSE2_224)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_256(buffer, 256, 0xfd4c799d, cksum, 224);
	...
	TEST(Test256ByteBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash128_256(buffer, 256, 0xfd4c799d, cksum, 256);
	...
	TEST(Test512ByteBufferSSE2_384)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash128_512(buffer, 512, 0xfd4c799d, cksum, 384);
	...
	TEST(Test512ByteBufferSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash128_512(buffer, 512, 0xfd4c799d, cksum, 512);
	...
	TEST(Test1024ByteBufferSSE2_768)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_1024(buffer, 1024, 0xfd4c799d, cksum, 768);
	...
	TEST(Test1024ByteBufferSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test1024", 1024, buffer) );
			VectorHash128_1024(buffer, 1024, 0xfd4c799d, cksum, 1024);
	...
	TEST(Test384ByteBufferSSE2_32)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_32(buffer, 384, 0xfd4c799d, cksum, 32);
	...
	TEST(Test384ByteBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash128_64(buffer, 384, 0xfd4c799d, cksum, 64);
	...
	TEST(Test384ByteBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash128_128(buffer, 384, 0xfd4c799d, cksum, 128);
	...
	TEST(Test384ByteBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash128_256(buffer, 384, 0xfd4c799d, cksum, 256);
	...
	TEST(Test768ByteBufferSSE2_512)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_512(buffer, 768, 0xfd4c799d, cksum, 512);
	...
	TEST(Test1536ByteBufferSSE2_1024)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_1024(buffer, 1536, 0xfd4c799d, cksum, 1024);
	...
	TEST(TestLargeBufferSSE2_32)
	{
		if( SIMDversion >= IS_SSE2 )
		{
			...
			VectorHash128_32(buffer, 1048576, 0xfd4c799d, cksum, 32);
	...
	TEST(TestLargeBufferSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_64(buffer, 1048576, 0xfd4c799d, cksum, 64);
	...
	TEST(TestLargeBufferSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_128(buffer, 1048576, 0xfd4c799d, cksum, 128);
	...
	TEST(TestLargeBufferSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_256(buffer, 1048576, 0xfd4c799d, cksum, 256);
	...
	TEST(TestLargeBufferSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_512(buffer, 1048576, 0xfd4c799d, cksum, 512);
	...
	TEST(TestLargeBufferSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_1024(buffer, 1048576, 0xfd4c799d, cksum, 1024);
	...
	TEST(TestLargeBufferAltSeedSSE2_32)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_32(buffer, 1048576, 0x6ec74615, cksum, 32);
	...
	TEST(TestLargeBufferAltSeedSSE2_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_64(buffer, 1048576, 0x6ec74615, cksum, 64);
	...
	TEST(TestLargeBufferAltSeedSSE2_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_128(buffer, 1048576, 0x6ec74615, cksum, 128);
	...
	TEST(TestLargeBufferAltSeedSSE2_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_256(buffer, 1048576, 0x6ec74615, cksum, 256);
	...
	TEST(TestLargeBufferAltSeedSSE2_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_512(buffer, 1048576, 0x6ec74615, cksum, 512);
	...
	TEST(TestLargeBufferAltSeedSSE2_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash128_1024(buffer, 1048576, 0x6ec74615, cksum, 1024);
