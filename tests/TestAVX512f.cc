...
namespace {
	...
	TEST(TestZeroLengthBufferAVX512_32)
	{
		...
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_AVX512, 32);
	...
	TEST(TestZeroLengthBufferAVX512_64)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_AVX512, 64);
	...
	TEST(TestZeroLengthBufferAVX512_128)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_AVX512, 128);
	...
	TEST(TestZeroLengthBufferAVX512_256)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_AVX512, 256);
	...
	TEST(TestZeroLengthBufferAVX512_512)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_AVX512, 512);
	...
	TEST(TestZeroLengthBufferAVX512_1024)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHashSIMD(buffer, 0, 0xfd4c799d, cksum, IS_AVX512, 1024);
	...
	TEST(Test128ByteBufferAVX512_32)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 32);
	...
	TEST(Test128ByteBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 64);
	...
	TEST(Test128ByteBufferAVX512_96)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 96);
	...
	TEST(Test128ByteBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 128);
	...
	TEST(Test128ByteBufferAVX512_160)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 160);
	...
	TEST(Test128ByteBufferAVX512_192)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 192);
	...
	TEST(Test128ByteBufferAVX512_224)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 224);
	...
	TEST(Test128ByteBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHashSIMD(buffer, 128, 0xfd4c799d, cksum, IS_AVX512, 256);
	...
	TEST(Test256ByteBufferAVX512_384)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 384);
	...
	TEST(Test256ByteBufferAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 512);
	...
	TEST(Test512ByteBufferAVX512_768)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_AVX512, 768);
	...
	TEST(Test512ByteBufferAVX512_1024)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_AVX512, 1024);
	...
	TEST(Test256ByteBufferAVX512_32)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 32);
	...
	TEST(Test256ByteBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 64);
	...
	TEST(Test256ByteBufferAVX512_96)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 96);
	...
	TEST(Test256ByteBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 128);
	...
	TEST(Test256ByteBufferAVX512_160)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 160);
	...
	TEST(Test256ByteBufferAVX512_192)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 192);
	...
	TEST(Test256ByteBufferAVX512_224)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 224);
	...
	TEST(Test256ByteBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHashSIMD(buffer, 256, 0xfd4c799d, cksum, IS_AVX512, 256);
	...
	TEST(Test512ByteBufferAVX512_384)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_AVX512, 384);
	...
	TEST(Test512ByteBufferAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHashSIMD(buffer, 512, 0xfd4c799d, cksum, IS_AVX512, 512);
	...
	TEST(Test1024ByteBufferAVX512_768)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 1024, 0xfd4c799d, cksum, IS_AVX512, 768);
	...
	TEST(Test1024ByteBufferAVX512_1024)
	{
		...
		{
			CHECK( ReadBuffer("test1024", 1024, buffer) );
			VectorHashSIMD(buffer, 1024, 0xfd4c799d, cksum, IS_AVX512, 1024);
	...
	TEST(Test384ByteBufferAVX512_32)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_AVX512, 32);
	...
	TEST(Test384ByteBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_AVX512, 64);
	...
	TEST(Test384ByteBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_AVX512, 128);
	...
	TEST(Test384ByteBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHashSIMD(buffer, 384, 0xfd4c799d, cksum, IS_AVX512, 256);
	...
	TEST(Test768ByteBufferAVX512_512)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 768, 0xfd4c799d, cksum, IS_AVX512, 512);
	...
	TEST(Test1536ByteBufferAVX512_1024)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 1536, 0xfd4c799d, cksum, IS_AVX512, 1024);
	...
	TEST(TestLargeBufferAVX512_32)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_AVX512, 32);
	...
	TEST(TestLargeBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_AVX512, 64);
	...
	TEST(TestLargeBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_AVX512, 128);
	...
	TEST(TestLargeBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_AVX512, 256);
	...
	TEST(TestLargeBufferAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_AVX512, 512);
	...
	TEST(TestLargeBufferAVX512_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0xfd4c799d, cksum, IS_AVX512, 1024);
	...
	TEST(TestLargeBufferAltSeedAVX512_32)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_AVX512, 32);
	...
	TEST(TestLargeBufferAltSeedAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_AVX512, 64);
	...
	TEST(TestLargeBufferAltSeedAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_AVX512, 128);
	...
	TEST(TestLargeBufferAltSeedAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_AVX512, 256);
	...
	TEST(TestLargeBufferAltSeedAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_AVX512, 512);
	...
	TEST(TestLargeBufferAltSeedAVX512_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHashSIMD(buffer, 1048576, 0x6ec74615, cksum, IS_AVX512, 1024);
