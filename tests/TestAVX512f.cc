...
namespace {
	...
	TEST(TestZeroLengthBufferAVX512_64)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHash512_64(buffer, 0, 0xfd4c799d, cksum);
	...
	TEST(TestZeroLengthBufferAVX512_128)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHash512_128(buffer, 0, 0xfd4c799d, cksum);
	...
	TEST(TestZeroLengthBufferAVX512_256)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHash512_256(buffer, 0, 0xfd4c799d, cksum);
	...
	TEST(TestZeroLengthBufferAVX512_512)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHash512_512(buffer, 0, 0xfd4c799d, cksum);
	...
	TEST(TestZeroLengthBufferAVX512_1024)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			VectorHash512_1024(buffer, 0, 0xfd4c799d, cksum);
	...
	TEST(Test128ByteBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash512_64(buffer, 128, 0xfd4c799d, cksum);
	...
	TEST(Test128ByteBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash512_128(buffer, 128, 0xfd4c799d, cksum);
	...
	TEST(Test128ByteBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test0128", 128, buffer) );
			VectorHash512_256(buffer, 128, 0xfd4c799d, cksum);
	...
	TEST(Test256ByteBufferAVX512_512)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHash512_512(buffer, 256, 0xfd4c799d, cksum);
	...
	TEST(Test512ByteBufferAVX512_1024)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHash512_1024(buffer, 512, 0xfd4c799d, cksum);
	...
	TEST(Test256ByteBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash512_64(buffer, 256, 0xfd4c799d, cksum);
	...
	TEST(Test256ByteBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash512_128(buffer, 256, 0xfd4c799d, cksum);
	...
	TEST(Test256ByteBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test0256", 256, buffer) );
			VectorHash512_256(buffer, 256, 0xfd4c799d, cksum);
	...
	TEST(Test512ByteBufferAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test0512", 512, buffer) );
			VectorHash512_512(buffer, 512, 0xfd4c799d, cksum);
	...
	TEST(Test1024ByteBufferAVX512_1024)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHash512_1024(buffer, 1024, 0xfd4c799d, cksum);
	...
	TEST(Test384ByteBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash512_64(buffer, 384, 0xfd4c799d, cksum);
	...
	TEST(Test384ByteBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash512_128(buffer, 384, 0xfd4c799d, cksum);
	...
	TEST(Test384ByteBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test0384", 384, buffer) );
			VectorHash512_256(buffer, 384, 0xfd4c799d, cksum);
	...
	TEST(Test768ByteBufferAVX512_512)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHash512_512(buffer, 768, 0xfd4c799d, cksum);
	...
	TEST(Test1536ByteBufferAVX512_1024)
	{
		if( SIMDversion >= IS_AVX512 )
		{
			...
			VectorHash512_1024(buffer, 1536, 0xfd4c799d, cksum);
	...
	TEST(TestLargeBufferAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_64(buffer, 1048576, 0xfd4c799d, cksum);
	...
	TEST(TestLargeBufferAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_128(buffer, 1048576, 0xfd4c799d, cksum);
	...
	TEST(TestLargeBufferAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_256(buffer, 1048576, 0xfd4c799d, cksum);
	...
	TEST(TestLargeBufferAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_512(buffer, 1048576, 0xfd4c799d, cksum);
	...
	TEST(TestLargeBufferAVX512_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_1024(buffer, 1048576, 0xfd4c799d, cksum);
	...
	TEST(TestLargeBufferAltSeedAVX512_64)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_64(buffer, 1048576, 0x6ec74615, cksum);
	...
	TEST(TestLargeBufferAltSeedAVX512_128)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_128(buffer, 1048576, 0x6ec74615, cksum);
	...
	TEST(TestLargeBufferAltSeedAVX512_256)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_256(buffer, 1048576, 0x6ec74615, cksum);
	...
	TEST(TestLargeBufferAltSeedAVX512_512)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_512(buffer, 1048576, 0x6ec74615, cksum);
	...
	TEST(TestLargeBufferAltSeedAVX512_1024)
	{
		...
		{
			CHECK( ReadBuffer("test9999", 1048576, buffer) );
			VectorHash512_1024(buffer, 1048576, 0x6ec74615, cksum);
